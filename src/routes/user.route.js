...
import { userResHandler , loginUserHandler , logoutUserHandler , refreshTokenHandler} from "../controllers/user.controller.js";
...
userRouter.route('/refresh-login').post(refreshTokenHandler)
